    ...
    private ViewPager.OnPageChangeListener onPageChangeListener = new ViewPager.OnPageChangeListener() {
        ...
        private void childOnPageSelectedLoop(final int paramAnonymousInt) {
            ...
            if (localObject != null) {
                ...
                JSLog.e("onPageSelected : " + (fragment.isAdded() + " " + fragment.getActivity() + " " + localObject));
                    ...
                    if (fragment.isAdded()) {
                        ...
                        handler.postDelayed(new Runnable() {
                            public void run() {
                                ...
                                JSLog.e(" delayed childOnPageSelectedLoop : " + paramAnonymousInt + "  "
                                        + repeate_count2 + "  "
        ...
        private void onPageSelectedLoop(final int paramAnonymousInt) {
            ...
            JSLog.e(" fragmentList : " + localList);
            if (localList == null) {
...
//                    LazyViewPager.access$202(LazyViewPager.this, new WeakHandler());
                ...
                LazyViewPager.this.handler.postDelayed(new Runnable() {
                    public void run() {
                        ...
                        JSLog.e(" delayed onPageSelectedLoop : " + paramAnonymousInt + "  " + repeate_count);
        ...
        public void onPageSelected(int paramAnonymousInt) {
            JSLog.e("onPageSelected : " + paramAnonymousInt);
            if (LazyViewPager.this.deliverPageChangeListener != null) {
    ...
    public void setFirstPositionCurrentItem() {
        if (getCurrentItem() == 0) {
            JSLog.e("setCurrentItem onPageSelected custom ");
    ...
    public void setOnPageChangeListener(ViewPager.OnPageChangeListener paramf) {
        if (this.isInit) {
            JSLog.e("111111111" + paramf + "     " + this);
            this.deliverPageChangeListener = paramf;
            return;
        }
        JSLog.e("2222222222" + paramf + "     " + this);
