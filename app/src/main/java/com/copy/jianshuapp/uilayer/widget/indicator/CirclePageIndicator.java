package com.copy.jianshuapp.uilayer.widget.indicator;
 ...
 * @see <a href="https://github.com/H07000223/FlycoPageIndicator">FlycoPageIndicator</a>
 */
public class CirclePageIndicator extends View implements ViewPager.OnPageChangeListener {
    ...
    public CirclePageIndicator(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray ta = context.obtainStyledAttributes(attrs, com.flyco.pageindicator.R.styleable.RoundCornerIndicaor);
        indicatorWidth = ta.getDimensionPixelSize(com.flyco.pageindicator.R.styleable.RoundCornerIndicaor_rci_width, dp2px(6));
        indicatorHeight = ta.getDimensionPixelSize(com.flyco.pageindicator.R.styleable.RoundCornerIndicaor_rci_height, dp2px(6));
        indicatorGap = ta.getDimensionPixelSize(com.flyco.pageindicator.R.styleable.RoundCornerIndicaor_rci_gap, dp2px(8));
        cornerRadius = ta.getDimensionPixelSize(com.flyco.pageindicator.R.styleable.RoundCornerIndicaor_rci_cornerRadius, dp2px(3));
        strokeWidth = ta.getDimensionPixelSize(com.flyco.pageindicator.R.styleable.RoundCornerIndicaor_rci_strokeWidth, dp2px(0));
        selectColor = ta.getColor(com.flyco.pageindicator.R.styleable.RoundCornerIndicaor_rci_selectColor, Color.WHITE);
        unselectColor = ta.getColor(com.flyco.pageindicator.R.styleable.RoundCornerIndicaor_rci_unselectColor, Color.parseColor("#88ffffff"));
        strokeColor = ta.getColor(com.flyco.pageindicator.R.styleable.RoundCornerIndicaor_rci_strokeColor, Color.WHITE);
        isSnap = ta.getBoolean(com.flyco.pageindicator.R.styleable.RoundCornerIndicaor_rci_isSnap, false);
