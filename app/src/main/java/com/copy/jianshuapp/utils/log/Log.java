...
class Log {
	...
	protected static void log(JSLevel level, String tag, Object... messages) {
		boolean isLog = false;
	 ...
	 * 按级别，输出格式化后的消息
	 */
	protected static void format(JSLevel level, String tag, String format, Object... args) {
        log(level, tag, buildMessage(format, args));
    }
	/**
	 * 按级别，输出格式化后的消息+异常信息
	 */
    protected static void format(JSLevel level, String tag, Throwable exception, String format, Object... args) {
