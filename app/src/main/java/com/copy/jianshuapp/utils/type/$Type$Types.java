package com.copy.jianshuapp.utils.type;

import static com.copy.jianshuapp.utils.type.$Type$Preconditions.checkArgument;
import static com.copy.jianshuapp.utils.type.$Type$Preconditions.checkNotNull;
...
class $Type$Types {
    ...
    static Type getSupertype(Type context, Class<?> contextRawType,
        ...
        return resolve(context, contextRawType,
                $Type$Types.getGenericSupertype(context, contextRawType,
                        supertype));
    }
    ...
    public static Type getArrayComponentType(Type array) {
        return array instanceof GenericArrayType ? ((GenericArrayType) array)
                .getGenericComponentType() : ((Class<?>) array)
                .getComponentType();
    }
    ...
    private static final class ParameterizedTypeImpl implements
        ...
        public ParameterizedTypeImpl(Type ownerType, Type rawType,
            ...
            if (rawType instanceof Class<?>) {
                ...
                boolean isStaticOrTopLevelClass = Modifier
                        .isStatic(rawTypeAsClass.getModifiers())
        ...
        public boolean equals(Object other) {
            return other instanceof ParameterizedType
                    && $Type$Types.equals(this, (ParameterizedType) other);
        }
    ...
    private static final class GenericArrayTypeImpl implements
        ...
        public boolean equals(Object o) {
            return o instanceof GenericArrayType
                    && $Type$Types.equals(this, (GenericArrayType) o);
        }
    ...
    private static final class WildcardTypeImpl implements WildcardType,
        ...
        public boolean equals(Object other) {
            return other instanceof WildcardType
                    && $Type$Types.equals(this, (WildcardType) other);
        }
