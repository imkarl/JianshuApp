...
public class TypeToken<T> {
    ...
    protected TypeToken() {
        ...
        this.rawType = (Class<? super T>) $Type$Types.getRawType(type);
    ...
    @SuppressWarnings("unchecked")
    TypeToken(Type type) {
        this.type = $Type$Types.canonicalize($Type$Preconditions
                .checkNotNull(type));
        this.rawType = (Class<? super T>) $Type$Types.getRawType(this.type);
        this.hashCode = this.type.hashCode();
    }

    /**
     * Returns the type from super class's type parameter in
     * {@link $Type$Types#canonicalize canonical form}.
     */
    ...
    public boolean isAssignableFrom(Type from) {
        ...
        if (type instanceof Class<?>) {
            return rawType.isAssignableFrom($Type$Types.getRawType(from));
    ...
    private static boolean isAssignableFrom(Type from, ParameterizedType to,
        ...
        return isAssignableFrom(sType, to,
                new HashMap<String, Type>(typeVarMap));
    }
    ...
    private static AssertionError buildUnexpectedTypeError(Type token,
        ...
        exceptionMessage.append("but got: ").append(token.getClass().getName())
                .append(", for type token: ").append(token.toString())
                .append('.');
    ...
    public final boolean equals(Object o) {
        return o instanceof TypeToken<?>
                && $Type$Types.equals(type, ((TypeToken<?>) o).type);
    }

    @Override
    public final String toString() {
        return $Type$Types.typeToString(type);
    }
